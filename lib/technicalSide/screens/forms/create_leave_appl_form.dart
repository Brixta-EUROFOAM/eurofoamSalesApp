// lib/technicalSide/screens/forms/create_leave_appl_form.dart
...
class CreateLeaveApplicationForm extends StatefulWidget {
  ...
  State<CreateLeaveApplicationForm> createState() =>
      _CreateLeaveApplicationFormState();
}

class _CreateLeaveApplicationFormState
    extends State<CreateLeaveApplicationForm> {
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              ...
              onSurface: _cardNavy, // Body text color
            ),
          ),
          child: child!,
        );
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _cardNavy, // Navy Blue
      ...
      child: InputDecorator(
        decoration: InputDecoration(
          ...
          suffixIcon: Icon(
            ...
            color: _cardNavy, // Navy Blue Icon
          ), 
        ),
        child: Text(
